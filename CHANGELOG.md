...
### Changed
- update contact email to contato@bridglabs.com

## [2.1.2] - 2026-03-03

### Fixed
- update setup command to match Claude Code statusLine schema

### Changed
- migrate commands/ to skills/ for autocomplete discovery

### Documentation
- update CLAUDE.md to reflect skills/ directory structure
